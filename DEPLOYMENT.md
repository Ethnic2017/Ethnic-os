...
Seulement **3 secrets** nécessaires (FTP server et username sont hardcodés) :
...
| `FTP_PASSWORD` | (mot de passe FTP OVH du compte `ethnicb`) |

**FTP serveur (hardcodé dans le workflow)** :
